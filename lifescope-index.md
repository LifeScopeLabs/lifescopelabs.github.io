...
We want to build lifescope open source as a platform for anything you want to do with your personal data. LifeData sources, API, datastructure, view components LifeScope is still in early days, but we have plans to expand this platform so it can power the next generation of software technology. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NjgxNDE1NzFdfQ==
-->